...
surf = cv.xfeatures2d_SURF.create(5000)  # surf function using n=5000 to get the most accurate matching points and make the process faster
...
cv.waitKey(0)
kp0 = surf.detect(img0)
desc0 = surf.compute(img0, kp0)
